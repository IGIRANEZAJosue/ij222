      ...
      <div className="p-4 w-[82vw] flex flex-col gap-4 " >
         ...
         <div className="flex w-full ">
            <div className="flex-[3]">
               ...
               <div className="transactions  bg-white dark:bg-dark30 drop-shadow-xl p-4 rounded-md ">
                  <span className="title flex font-bold border-b-[1px] border-[#e5e5e5] dark:border-[#475569] mb-2">
